""" 
Painel de Evasão Escolar — Machine Learning (Streamlit)
...
# ------------------------------------------------------------------ config
st.set_page_config(page_title="Painel de Evasão Escolar — Machine Learning", layout="wide", page_icon="🎓")
...
<div class="rv-hdr">
  ...
  <div><h1> Painel de Evasão Escolar — Machine Learning</h1><p>Modelo preditivo V15.2 · HistGradientBoosting · score 0–100</p></div>
</div>
""", unsafe_allow_html=True)
...
st.caption("Projeto de Data Science aplicado à Educação — modelo preditivo para apoio à decisão. O score (0–100) vem do modelo V15.2; o status por indicador é uma leitura "
